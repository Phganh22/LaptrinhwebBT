...
<body>
    ...
    <section>
        ...
        <p>Họ và tên: <span class="info">Lê Phương Anh</span></p>
        <p>Mã sinh viên: <span class="info">224001766</span></p>
        <p>Lớp: <span class="info">Lập trình web_CNTT2024_N1</span></p>
        <p>Email: <span class="info">phuonganhhnd7@gmail.com</span></p>
    </section>
    ...
    <section>
        ...
        <div class="project-item">
            ...
            <p>Công nghệ sử dụng: HTML, CSS3, JavaScript.</p>
        </div>
